...
func (x *Config_WrappedFlag_Value) GetValue() isConfig_WrappedFlag_Value_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *Config_WrappedFlag_Value) GetIntVal() int32 {
	if x != nil {
		if x, ok := x.Value.(*Config_WrappedFlag_Value_IntVal); ok {
			return x.IntVal
		}
	}
	return 0
...
func (x *Config_WrappedFlag_Value) GetStrVal() string {
	if x != nil {
		if x, ok := x.Value.(*Config_WrappedFlag_Value_StrVal); ok {
			return x.StrVal
		}
	}
	return ""
...
const file_config_proto_rawDesc = "" +
	"\n" +
	"\fconfig.proto\x12\x06config\"\xce\x06\n" +
	"\x06Config\x12$\n" +
	"\rclientVersion\x18\x01 \x01(\tR\rclientVersion\x12$\n" +
	"\rserverVersion\x18\x02 \x01(\tR\rserverVersion\x12/\n" +
	"\bintFlags\x18\x03 \x03(\v2\x13.config.Config.FlagR\bintFlags\x126\n" +
	"\tmoreFlags\x18\x04 \x01(\v2\x18.config.Config.MoreFlagsR\tmoreFlags\x129\n" +
	"\n" +
	"deviceInfo\x18\x05 \x01(\v2\x19.config.Config.DeviceInfoR\n" +
	"deviceInfo\x12 \n" +
	"\vcountryCode\x18\a \x01(\tR\vcountryCode\x12 \n" +
	"\vunknownInts\x18\b \x03(\rR\vunknownInts\x12$\n" +
	"\rgeneratedAtMS\x18\t \x01(\x03R\rgeneratedAtMS\x1a\xa8\x01\n" +
	"\x04Flag\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x05R\x05value\x12)\n" +
	"\runknownField4\x18\x04 \x01(\tH\x00R\runknownField4\x88\x01\x01\x12)\n" +
	"\runknownField5\x18\x05 \x01(\tH\x01R\runknownField5\x88\x01\x01B\x10\n" +
	"\x0e_unknownField4B\x10\n" +
	"\x0e_unknownField5\x1a\x9d\x01\n" +
	"\vWrappedFlag\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x126\n" +
	"\x05value\x18\x02 \x01(\v2 .config.Config.WrappedFlag.ValueR\x05value\x1aD\n" +
	"\x05Value\x12\x18\n" +
	"\x06intVal\x18\x02 \x01(\x05H\x00R\x06intVal\x12\x18\n" +
	"\x06strVal\x18\x03 \x01(\tH\x00R\x06strValB\a\n" +
	"\x05value\x1aK\n" +
	"\tMoreFlags\x12>\n" +
	"\fwrappedFlags\x18\x01 \x03(\v2\x1a.config.Config.WrappedFlagR\fwrappedFlags\x1aR\n" +
	"\n" +
	"DeviceInfo\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email\x12\x12\n" +
	"\x04zero\x18\x03 \x01(\tR\x04zero\x12\x1a\n" +
	"\bdeviceID\x18\x04 \x01(\tR\bdeviceIDB\fZ\n" +
	"../gmprotob\x06proto3"
