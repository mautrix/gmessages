...
const (
	...
	GaiaPairingErrorCode_CLIENT_ATTESTATION_MISSING                        GaiaPairingErrorCode = 32
	GaiaPairingErrorCode_CLIENT_ATTESTATION_MISMATCH                       GaiaPairingErrorCode = 33
	GaiaPairingErrorCode_SI_RESPONSE_FROM_UNEXPECTED_PHONE_REGISTRATION_ID GaiaPairingErrorCode = 34
	GaiaPairingErrorCode_CLIENT_ATTESTATION_REVISION_MISMATCH              GaiaPairingErrorCode = 35
)
...
var (
	...
	GaiaPairingErrorCode_value = map[string]int32{
		...
		"CLIENT_ATTESTATION_MISSING":                        32,
		"CLIENT_ATTESTATION_MISMATCH":                       33,
		"SI_RESPONSE_FROM_UNEXPECTED_PHONE_REGISTRATION_ID": 34,
		"CLIENT_ATTESTATION_REVISION_MISMATCH":              35,
	}
)
...
type GaiaPairingRequestContainer struct {
	...
	PrivateAPIConfirmation          string                 `protobuf:"bytes,8,opt,name=privateAPIConfirmation,proto3" json:"privateAPIConfirmation,omitempty"`
	unknownFields                   protoimpl.UnknownFields
	sizeCache                       protoimpl.SizeCache
}
...
func (x *GaiaPairingRequestContainer) GetPrivateAPIConfirmation() string {
	if x != nil {
		return x.PrivateAPIConfirmation
	}
	return ""
}
...
type GaiaPairingResponseContainer struct {
	...
	UnknownBytes                     []byte                 `protobuf:"bytes,8,opt,name=unknownBytes,proto3" json:"unknownBytes,omitempty"`
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
}
...
func (x *GaiaPairingResponseContainer) GetUnknownBytes() []byte {
	if x != nil {
...
const file_authentication_proto_rawDesc = "" +
	...
	"\rDeviceWrapper\x12.\n" +
	"\x06device\x18\x01 \x01(\v2\x16.authentication.DeviceR\x06device\"\x93\x03\n" +
	...
	"\x1cproposedKeyDerivationVersion\x18\x06 \x01(\x05R\x1cproposedKeyDerivationVersion\x126\n" +
	"\x16privateAPIConfirmation\x18\b \x01(\tR\x16privateAPIConfirmation\"\xa6\x03\n" +
	...
	" UNABLE_TO_DECRYPT_CMS_BACKUP_KEY\x10\x1f\x12\x1e\n" +
	"\x1aCLIENT_ATTESTATION_MISSING\x10 \x12\x1f\n" +
	"\x1bCLIENT_ATTESTATION_MISMATCH\x10!\x125\n" +
	"1SI_RESPONSE_FROM_UNEXPECTED_PHONE_REGISTRATION_ID\x10\"\x12(\n" +
	"$CLIENT_ATTESTATION_REVISION_MISMATCH\x10#B\fZ\n" +
	"../gmprotob\x06proto3"
