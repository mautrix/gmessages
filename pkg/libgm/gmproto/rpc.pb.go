...
const (
	...
	ActionType_PRE_FETCH_CONTACTS                     ActionType = 52
	ActionType_FETCH_BLOCKED_CONTACTS                 ActionType = 53
	ActionType_REMOVE_PARTICIPANT_FROM_RCS_GROUP      ActionType = 54
	ActionType_UPDATE_GROUP_ICON                      ActionType = 55
	ActionType_FETCH_DESTINATIONS_TO_CONVERSATIONS    ActionType = 56
)
...
var (
	ActionType_name = map[int32]string{
		...
		52: "PRE_FETCH_CONTACTS",
		53: "FETCH_BLOCKED_CONTACTS",
		54: "REMOVE_PARTICIPANT_FROM_RCS_GROUP",
		55: "UPDATE_GROUP_ICON",
		56: "FETCH_DESTINATIONS_TO_CONVERSATIONS",
	}
	ActionType_value = map[string]int32{
		...
		"PRE_FETCH_CONTACTS":                     52,
		"FETCH_BLOCKED_CONTACTS":                 53,
		"REMOVE_PARTICIPANT_FROM_RCS_GROUP":      54,
		"UPDATE_GROUP_ICON":                      55,
		"FETCH_DESTINATIONS_TO_CONVERSATIONS":    56,
	}
)
...
const file_rpc_proto_rawDesc = "" +
	"\n" +
	"\trpc.proto\x12\x03rpc\x1a\x14authentication.proto\x1a\n" +
	"util.proto\x1a\x13vendor/pblite.proto\"6\n" +
	"\x0fStartAckMessage\x12\x19\n" +
	"\x05count\x18\x01 \x01(\x05H\x00R\x05count\x88\x01\x01B\b\n" +
	"\x06_count\"\x86\x02\n" +
	"\x12LongPollingPayload\x120\n" +
	"\x04data\x18\x02 \x01(\v2\x17.rpc.IncomingRPCMessageH\x00R\x04data\x88\x01\x01\x121\n" +
	"\theartbeat\x18\x03 \x01(\v2\x0e.util.EmptyArrH\x01R\theartbeat\x88\x01\x01\x12+\n" +
	"\x03ack\x18\x04 \x01(\v2\x14.rpc.StartAckMessageH\x02R\x03ack\x88\x01\x01\x121\n" +
	"\tstartRead\x18\x05 \x01(\v2\x0e.util.EmptyArrH\x03R\tstartRead\x88\x01\x01B\a\n" +
	"\x05_dataB\f\n" +
	"\n" +
	"_heartbeatB\x06\n" +
	"\x04_ackB\f\n" +
	"\n" +
	"_startRead\"\xcb\x04\n" +
	"\x12IncomingRPCMessage\x12\x1e\n" +
	"\n" +
	"responseID\x18\x01 \x01(\tR\n" +
	"responseID\x12/\n" +
	"\n" +
	"bugleRoute\x18\x02 \x01(\x0e2\x0f.rpc.BugleRouteR\n" +
	"bugleRoute\x12\"\n" +
	"\fstartExecute\x18\x03 \x01(\x04R\fstartExecute\x122\n" +
	"\vmessageType\x18\x05 \x01(\x0e2\x10.rpc.MessageTypeR\vmessageType\x12$\n" +
	"\rfinishExecute\x18\x06 \x01(\x04R\rfinishExecute\x12,\n" +
	"\x11microsecondsTaken\x18\a \x01(\x04R\x11microsecondsTaken\x12.\n" +
	"\x06mobile\x18\b \x01(\v2\x16.authentication.DeviceR\x06mobile\x120\n" +
	"\abrowser\x18\t \x01(\v2\x16.authentication.DeviceR\abrowser\x12 \n" +
	"\vmessageData\x18\f \x01(\fR\vmessageData\x12 \n" +
	"\vsignatureID\x18\x11 \x01(\tR\vsignatureID\x12\x1c\n" +
	"\ttimestamp\x18\x15 \x01(\tR\ttimestamp\x12H\n" +
	"\fgdittoSource\x18\x17 \x01(\v2$.rpc.IncomingRPCMessage.GDittoSourceR\fgdittoSource\x1a*\n" +
	"\fGDittoSource\x12\x1a\n" +
	"\bdeviceID\x18\x02 \x01(\x05R\bdeviceID\"\xaf\x02\n" +
	"\x0eRPCMessageData\x12\x1c\n" +
	"\tsessionID\x18\x01 \x01(\tR\tsessionID\x12\x1c\n" +
	"\ttimestamp\x18\x03 \x01(\x03R\ttimestamp\x12'\n" +
	"\x06action\x18\x04 \x01(\x0e2\x0f.rpc.ActionTypeR\x06action\x12(\n" +
	"\x0funencryptedData\x18\x05 \x01(\fR\x0funencryptedData\x12\x14\n" +
	"\x05bool1\x18\x06 \x01(\bR\x05bool1\x12\x14\n" +
	"\x05bool2\x18\a \x01(\bR\x05bool2\x12$\n" +
	"\rencryptedData\x18\b \x01(\fR\rencryptedData\x12\x14\n" +
	"\x05bool3\x18\t \x01(\bR\x05bool3\x12&\n" +
	"\x0eencryptedData2\x18\v \x01(\fR\x0eencryptedData2\"\xb9\x05\n" +
	"\x12OutgoingRPCMessage\x12.\n" +
	"\x06mobile\x18\x01 \x01(\v2\x16.authentication.DeviceR\x06mobile\x120\n" +
	"\x04data\x18\x02 \x01(\v2\x1c.rpc.OutgoingRPCMessage.DataR\x04data\x120\n" +
	"\x04auth\x18\x03 \x01(\v2\x1c.rpc.OutgoingRPCMessage.AuthR\x04auth\x12\x10\n" +
	"\x03TTL\x18\x05 \x01(\x03R\x03TTL\x126\n" +
	"\x13destRegistrationIDs\x18\t \x03(\tB\x04\x80\xb5\x18\x01R\x13destRegistrationIDs\x1a\x95\x01\n" +
	"\x04Auth\x12\x1c\n" +
	"\trequestID\x18\x01 \x01(\tR\trequestID\x12*\n" +
	"\x10tachyonAuthToken\x18\x06 \x01(\fR\x10tachyonAuthToken\x12C\n" +
	"\rconfigVersion\x18\a \x01(\v2\x1d.authentication.ConfigVersionR\rconfigVersion\x1a\xac\x02\n" +
	"\x04Data\x12\x1c\n" +
	"\trequestID\x18\x01 \x01(\tR\trequestID\x12/\n" +
	"\n" +
	"bugleRoute\x18\x02 \x01(\x0e2\x0f.rpc.BugleRouteR\n" +
	"bugleRoute\x12 \n" +
	"\vmessageData\x18\f \x01(\fR\vmessageData\x12K\n" +
	"\x0fmessageTypeData\x18\x17 \x01(\v2!.rpc.OutgoingRPCMessage.Data.TypeR\x0fmessageTypeData\x1af\n" +
	"\x04Type\x12*\n" +
	"\bemptyArr\x18\x01 \x01(\v2\x0e.util.EmptyArrR\bemptyArr\x122\n" +
	"\vmessageType\x18\x02 \x01(\x0e2\x10.rpc.MessageTypeR\vmessageType\"\xda\x01\n" +
	"\x0fOutgoingRPCData\x12\x1c\n" +
	"\trequestID\x18\x01 \x01(\tR\trequestID\x12'\n" +
	"\x06action\x18\x02 \x01(\x0e2\x0f.rpc.ActionTypeR\x06action\x122\n" +
	"\x14unencryptedProtoData\x18\x03 \x01(\fR\x14unencryptedProtoData\x12.\n" +
	"\x12encryptedProtoData\x18\x05 \x01(\fR\x12encryptedProtoData\x12\x1c\n" +
	"\tsessionID\x18\x06 \x01(\tR\tsessionID\"\xc9\x01\n" +
	"\x13OutgoingRPCResponse\x12O\n" +
	"\x0esomeIdentifier\x18\x01 \x01(\v2'.rpc.OutgoingRPCResponse.SomeIdentifierR\x0esomeIdentifier\x12!\n" +
	"\ttimestamp\x18\x02 \x01(\tH\x00R\ttimestamp\x88\x01\x01\x1a0\n" +
	"\x0eSomeIdentifier\x12\x1e\n" +
	"\n" +
	"someNumber\x18\x02 \x01(\tR\n" +
	"someNumberB\f\n" +
	"\n" +
	"_timestamp*F\n" +
	"\n" +
	...
	"\tDataEvent\x10\x13\x12\r\n" +
	"\tPairEvent\x10\x0e\x12\r\n" +
	"\tGaiaEvent\x10\a*\x82\v\n" +
	"\n" +
	"ActionType\x12\x0f\n" +
	"\vUNSPECIFIED\x10\x00\x12\x16\n" +
	"\x12LIST_CONVERSATIONS\x10\x01\x12\x11\n" +
	"\rLIST_MESSAGES\x10\x02\x12\x10\n" +
	"\fSEND_MESSAGE\x10\x03\x12\x13\n" +
	"\x0fMESSAGE_UPDATES\x10\x04\x12\x11\n" +
	"\rLIST_CONTACTS\x10\x06\x12\x18\n" +
	"\x14CONVERSATION_UPDATES\x10\a\x12\x1e\n" +
	"\x1aGET_OR_CREATE_CONVERSATION\x10\t\x12\x10\n" +
	"\fMESSAGE_READ\x10\n" +
	"\x12\x1a\n" +
	"\x16BROWSER_PRESENCE_CHECK\x10\v\x12\x12\n" +
	"\x0eTYPING_UPDATES\x10\f\x12\x13\n" +
	"\x0fSETTINGS_UPDATE\x10\r\x12\x0e\n" +
	"\n" +
	"USER_ALERT\x10\x0e\x12\x17\n" +
	"\x13UPDATE_CONVERSATION\x10\x0f\x12\x0f\n" +
	"\vGET_UPDATES\x10\x10\x12\x18\n" +
	"\x14ACK_BROWSER_PRESENCE\x10\x11\x12\x15\n" +
	"\x11LIST_STICKER_SETS\x10\x12\x12\x13\n" +
	"\x0fLEAVE_RCS_GROUP\x10\x13\x12 \n" +
	"\x1cADD_PARTICIPANT_TO_RCS_GROUP\x10\x14\x12\x19\n" +
	"\x15GET_CONVERSATION_TYPE\x10\x15\x12\x19\n" +
	"\x15NOTIFY_DITTO_ACTIVITY\x10\x16\x12\x12\n" +
	"\x0eDELETE_MESSAGE\x10\x17\x12\x17\n" +
	"\x13INSTALL_STICKER_SET\x10\x18\x12\x12\n" +
	"\x0eRESEND_MESSAGE\x10\x19\x12 \n" +
	"\x1cGET_CONTACT_RCS_GROUP_STATUS\x10\x1a\x12\x14\n" +
	"\x10DOWNLOAD_MESSAGE\x10\x1b\x12\x15\n" +
	"\x11LIST_TOP_CONTACTS\x10\x1c\x12\x1a\n" +
	"\x16GET_CONTACTS_THUMBNAIL\x10\x1d\x12\x1c\n" +
	"\x18CHANGE_PARTICIPANT_COLOR\x10\x1e\x12\x14\n" +
	"\x10IS_BUGLE_DEFAULT\x10\x1f\x12\x18\n" +
	"\x14STICKER_USER_CONTEXT\x10 \x12\x1a\n" +
	"\x16FAVORITE_STICKER_PACKS\x10!\x12\x13\n" +
	"\x0fRECENT_STICKERS\x10\"\x12\x1a\n" +
	"\x16UPDATE_RECENT_STICKERS\x10#\x12\x17\n" +
	"\x13GET_FULL_SIZE_IMAGE\x10$\x12\x1e\n" +
	"\x1aGET_PARTICIPANTS_THUMBNAIL\x10%\x12\x11\n" +
	"\rSEND_REACTION\x10&\x12\x0e\n" +
	"\n" +
	"SEND_REPLY\x10'\x12\x1b\n" +
	"\x17GET_BLOB_FOR_ATTACHMENT\x10(\x12*\n" +
	"&GET_DEVICES_AVAILABLE_FOR_GAIA_PAIRING\x10)\x12\x17\n" +
	"\x13CREATE_GAIA_PAIRING\x10*\x12\x14\n" +
	"\x10GET_CONVERSATION\x10+\x12#\n" +
	"\x1fCREATE_GAIA_PAIRING_CLIENT_INIT\x10,\x12'\n" +
	"#CREATE_GAIA_PAIRING_CLIENT_FINISHED\x10-\x12\x17\n" +
	"\x13UNPAIR_GAIA_PAIRING\x10.\x12\x17\n" +
	"\x13CANCEL_GAIA_PAIRING\x10/\x12\v\n" +
	"\aPREWARM\x100\x12\"\n" +
	"\x1eCONVERSATION_GROUP_NAME_SEARCH\x101\x12\x15\n" +
	"\x11LINK_RCS_IDENTITY\x102\x12\x17\n" +
	"\x13UNLINK_RCS_IDENTITY\x103\x12\x16\n" +
	"\x12PRE_FETCH_CONTACTS\x104\x12\x1a\n" +
	"\x16FETCH_BLOCKED_CONTACTS\x105\x12%\n" +
	"!REMOVE_PARTICIPANT_FROM_RCS_GROUP\x106\x12\x15\n" +
	"\x11UPDATE_GROUP_ICON\x107\x12'\n" +
	"#FETCH_DESTINATIONS_TO_CONVERSATIONS\x108*h\n" +
	"\vMessageType\x12\x18\n" +
	"\x14UNKNOWN_MESSAGE_TYPE\x10\x00\x12\x11\n" +
	"\rBUGLE_MESSAGE\x10\x02\x12\n" +
	"\n" +
	"\x06GAIA_1\x10\x03\x12\x14\n" +
	"\x10BUGLE_ANNOTATION\x10\x10\x12\n" +
	"\n" +
	"\x06GAIA_2\x10\x14B\fZ\n" +
	"../gmprotob\x06proto3"
