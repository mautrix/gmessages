...
// Matches the native app's GroupId message: a stable RCS group identity that
// survives conversationID churn.
...
const file_conversations_proto_rawDesc = "" +
	...
	"\x10_formattedNumber\"\xc4\x01\n" +
	"\x11SomeKindOfGroupID\x12&\n" +
	"\x0econversationID\x18\x01 \x01(\tR\x0econversationID\x12E\n" +
	"\bnestedID\x18\x02 \x01(\v2).conversations.SomeKindOfGroupID.NestedIDR\bnestedID\x1a@\n" +
	"\bNestedID\x12\x0e\n" +
	...
	"statusText\x12\x1c\n" +
	"\tthirdCode\x18\x06 \x01(\x03R\tthirdCode\"\xaf\b\n" +
	"\fConversation\x12&\n" +
	...
	"\asimCard\x18  \x01(\v2\x11.settings.SIMCardR\asimCard\x12&\n" +
	"\x0egroupAvatarURL\x18\" \x01(\tR\x0egroupAvatarURL\x12U\n" +
