...
type SIMCard struct {
	...
	RcsAddress1    string                 `protobuf:"bytes,8,opt,name=rcsAddress1,proto3" json:"rcsAddress1,omitempty"`
	RcsAddress2    string                 `protobuf:"bytes,9,opt,name=rcsAddress2,proto3" json:"rcsAddress2,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *SIMCard) GetRcsAddress1() string {
	if x != nil {
		return x.RcsAddress1
	}
	return ""
}

func (x *SIMCard) GetRcsAddress2() string {
	if x != nil {
		return x.RcsAddress2
	}
	return ""
}
...
type SIMData struct {
	...
	InternationalPhoneNumber string                 `protobuf:"bytes,7,opt,name=internationalPhoneNumber,proto3" json:"internationalPhoneNumber,omitempty"` // index 8 has an unknown int or bool
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
type SomeData struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// optional for explicit presence: the phone omits this in some settings events, and an
	// absent field must not be read as "push is disabled"
	PushEnabled   *bool    `protobuf:"varint,3,opt,name=pushEnabled,proto3,oneof" json:"pushEnabled,omitempty"`
	...
	SomeTimestamp int64    `protobuf:"varint,23,opt,name=someTimestamp,proto3" json:"someTimestamp,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SomeData) GetSomeTimestamp() int64 {
	if x != nil {
		return x.SomeTimestamp
	}
	return 0
}
...
type RCSSettings struct {
	...
	// this field disappears from some settings events, so it needs explicit presence:
	// decoding an absent field as false makes the stored value flap between updates
	IsDefaultSMSApp *bool  `protobuf:"varint,4,opt,name=isDefaultSMSApp,proto3,oneof" json:"isDefaultSMSApp,omitempty"`
	UnknownInt      int32  `protobuf:"varint,5,opt,name=unknownInt,proto3" json:"unknownInt,omitempty"` // usually 1
	UnknownBytes    []byte `protobuf:"bytes,6,opt,name=unknownBytes,proto3" json:"unknownBytes,omitempty"`
	UnknownUUID1    string `protobuf:"bytes,7,opt,name=unknownUUID1,proto3" json:"unknownUUID1,omitempty"`
	UnknownUUID2    string `protobuf:"bytes,8,opt,name=unknownUUID2,proto3" json:"unknownUUID2,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *RCSSettings) GetIsDefaultSMSApp() bool {
	if x != nil && x.IsDefaultSMSApp != nil {
		return *x.IsDefaultSMSApp
	}
	return false
}

func (x *RCSSettings) GetUnknownInt() int32 {
	if x != nil {
		return x.UnknownInt
	}
	return 0
...
func (x *RCSSettings) GetUnknownBytes() []byte {
	if x != nil {
...
func (x *RCSSettings) GetUnknownUUID1() string {
	if x != nil {
...
func (x *RCSSettings) GetUnknownUUID2() string {
	if x != nil {
...
type BooleanFields2 struct {
	...
	Bool3         bool                   `protobuf:"varint,6,opt,name=bool3,proto3" json:"bool3,omitempty"` // field 8 has an object with a uuid and a timestamp
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type BooleanFields3 struct {
	...
	Bool9         bool                   `protobuf:"varint,9,opt,name=bool9,proto3" json:"bool9,omitempty"` // these go up to 34 nowadays
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_settings_proto_rawDesc = "" +
	...
	"\vboolFields3\x18\n" +
	" \x01(\v2\x18.settings.BooleanFields3R\vboolFields3\"\x94\x02\n" +
	"\aSIMCard\x123\n" +
	...
	"\x0eSIMParticipant\x18\a \x01(\v2\x18.settings.SIMParticipantR\x0eSIMParticipant\x12 \n" +
	"\vrcsAddress1\x18\b \x01(\tR\vrcsAddress1\x12 \n" +
	"\vrcsAddress2\x18\t \x01(\tR\vrcsAddress2B\v\n" +
	"\t_RCSChats\"$\n" +
	"\bRCSChats\x12\x18\n" +
	...
	"\bSomeData\x12%\n" +
	"\vpushEnabled\x18\x03 \x01(\bH\x00R\vpushEnabled\x88\x01\x01\x12\x16\n" +
	...
	"someString\x12$\n" +
	"\rsomeTimestamp\x18\x17 \x01(\x03R\rsomeTimestampB\x0e\n" +
	"\f_pushEnabled\"\xda\x02\n" +
	...
	"\x0fisDefaultSMSApp\x18\x04 \x01(\bH\x00R\x0fisDefaultSMSApp\x88\x01\x01\x12\x1e\n" +
	"\n" +
	"unknownInt\x18\x05 \x01(\x05R\n" +
	"unknownInt\x12\"\n" +
	"\funknownBytes\x18\x06 \x01(\fR\funknownBytes\x12\"\n" +
	"\funknownUUID1\x18\a \x01(\tR\funknownUUID1\x12\"\n" +
	"\funknownUUID2\x18\b \x01(\tR\funknownUUID2B\x12\n" +
	"\x10_isDefaultSMSApp\"\xb0\x01\n" +
...
func file_settings_proto_init() {
	...
	file_settings_proto_msgTypes[8].OneofWrappers = []any{}
